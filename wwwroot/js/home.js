...
// var showPageBreaks = new ej.buttons.CheckBox({ label: 'Page Breaks', checked:false, change: function (args) { DiagramPropertyBinding.prototype.pageBreaksChange(args); } });
