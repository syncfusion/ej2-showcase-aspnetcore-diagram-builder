    ...
    DiagramClientSideEvents.prototype.selectionChange = function (args) {
        ...
        if (args.state === 'Changed') {
            if (selectedItem.diagramType === 'MindMap') {
                ...
                var selectedItems =document.getElementById('diagram').ej2_instances[0].nodes;
                selectedItems = selectedItems.concat(document.getElementById('diagram').ej2_instances[0].connectors);
